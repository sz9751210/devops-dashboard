<template>
    <div>
      ...
      <!-- table -->
      <el-table :data="pagedData" style="width: 100%" @sort-change="handleSortChange">
        <el-table-column prop="domain" label="域名" width="180" />
        <el-table-column prop="subdomain" label="子域名" width="180" />
        <el-table-column prop="expiry_date" label="到期時間" width="150" sortable />
        <el-table-column prop="update_time" label="更新時間" width="150" sortable />
